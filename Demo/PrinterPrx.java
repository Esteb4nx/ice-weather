...
{
    default String getWeather(String city)
    {
        return getWeather(city, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getWeather(String city, java.util.Map<String, String> context)
    {
        return _iceI_getWeatherAsync(city, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getWeatherAsync(String city)
    {
        return _iceI_getWeatherAsync(city, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getWeatherAsync(String city, java.util.Map<String, String> context)
    {
        return _iceI_getWeatherAsync(city, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getWeatherAsync(String iceP_city, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getWeather", null, sync, null);
